    ...
    <section className="py-24 bg-muted/20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4 text-foreground">Why Choose PH Doc?</h2>
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="overflow-hidden border-none shadow-xl bg-background">
            <div className="grid grid-cols-3 bg-muted/50 p-6 border-b">
              ...
              <div className="col-span-1 text-center font-bold text-primary">PH Doc AI Platform</div>
            </div>
