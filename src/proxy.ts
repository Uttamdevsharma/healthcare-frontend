...
export const config = {
  matcher: [
     ...
     */
    // Exclude Next internals (/_next) so server actions and internal assets aren't intercepted
    "/((?!api|_next|_next/static|_next/image|favicon.ico|sitemap.xml|robots.txt|.well-known).*)",
  ],
};
